      ...
      <div className="bg-red-600">
        ...
        <div className="text-gray-700 bg-white">
          ...
          <section className="container mx-auto px-6 p-10">
            ...
            <div className="flex items-center flex-wrap mb-20">
              <div className="w-full md:w-1/2">
                ...
                <p className="text-gray-600 mb-8">
                  ...
                  vitals while you exercise. You can create different category
                  of exercises and can track your vitals on the go.
                </p>
              </div>
              <div className="w-full md:w-1/2">
                <Image
            ...
            <div className="flex items-center flex-wrap mb-20">
              <div className="w-full md:w-1/2">
                <Image width={600} height={600} src="/wq.jpg" alt="Reporting" />
              </div>
            ...
            <div className="flex items-center flex-wrap mb-20">
              <div className="w-full md:w-1/2">
                ...
                <p className="text-gray-600 mb-8">
                  ...
                  across all your mobile devices whether iOS, Android or Windows
                  OS and also to your laptop whether MacOS, GNU/Linux or Windows
                  OS.
                </p>
              </div>
              <div className="w-full md:w-1/2">
                <Image width={700} height={700} src="/qwwq.jpg" alt="Syncing" />
              </div>
            </div>
          </section>
          {/* <!-- Testimonials --> */}
            ...
            <div className="container mx-auto px-6 py-20">
              ...
              <div className="flex flex-wrap">
                ...
                <div className="w-full md:w-1/3 px-2 mb-4">
                  <div className="bg-white rounded shadow py-2">
                    <p className="text-gray-800 text-base px-6 mb-5">
                      As an Athlete, this is the perfect product for me. I wear
                      my Smart Health Monitoring Wristwatch everywhere I go,
                      even in the bathroom since it's waterproof.
                    </p>
                    <p className="text-gray-500 text-xs md:text-sm px-6">
                      Jane Doe
                    </p>
